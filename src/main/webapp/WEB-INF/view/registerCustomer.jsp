...
<head>
    ...
    <title>Register Customer | ABC Restaurant</title>
    ...
    <style>
        ...
        .form-control {
            ...
            color: #f8f9fa; /* Light text color */
            font-family: 'Poppins', sans-serif; /* Apply Poppins font to inputs */
        ...
        /* Title Styling */
        h1.text-center {
            font-size: 43px; /* Larger font size for title */
            font-weight: 500; /* Bold font weight for title */
...
<body>
    ...
    <div class="container">
        ...
        <form action="customer?action=register" method="post" class="mt-4">
        ...
        <div class="text-center mt-4">
            <p>Already a Member? <a href="customer?action=login">Login here</a></p>
        </div>
    </div>
